...
//
// specify the maximum number of constraint values per channel
//
#define MAX_NUM_CONSTRAINT_VALUES 4064

//
// specify the number of nearest neighbors to look at
//
#define NUM_NEAREST_NEIGHNORS 10
