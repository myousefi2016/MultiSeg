...
public:
    ...
    // segmentation state
    //
    void BeginPlaceSeed( SeedType seedType );
    void PlaceSeed( int screenX, int screenY, SeedType seedType );
    void EndPlaceSeed( SeedType seedType );

    void BeginInitializeSeed( SeedType seedType );
    void InitializeSeed( const math::Vector3& seedCoordinates, unsigned int sphereSize, SeedType seedType );
    void EndInitializeSeed( SeedType seedType );
